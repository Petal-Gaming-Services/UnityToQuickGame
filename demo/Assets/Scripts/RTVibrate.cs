...
namespace CRWASM
{
    class RTVibrate : MonoBehaviour
    {
        ...
        private static extern void RTVibrateShort(string callbackId);

        [DllImport("__Internal")]
        private static extern void RTVibrateLong(string callbackId);

#else

        private static void RTVibrateShort(string callbackId)
        {
            Debug.Log("RTVibrateShort not support");
        }

        private static void RTVibrateLong(string callbackId)
        {
            Debug.Log("RTVibrateLong not support");
        }
        ...
        public static RTVibrate Create()
        {
            RTVibrate instance = new GameObject(typeof(RTVibrate).Name).AddComponent<RTVibrate>();
            DontDestroyOnLoad(instance.gameObject);
            return instance;
        }

        public static void Destroy(RTVibrate instance)
        {
        ...
        public void vibrateShort(Action successCallback, Action failCallback, Action completeCallback)
        {
            string callbackId = RTCallback.AddCallback(successCallback, failCallback, completeCallback);
            RTVibrateShort(callbackId);
        }

        public void vibrateLong(Action successCallback, Action failCallback, Action completeCallback)
        {
            string callbackId = RTCallback.AddCallback(successCallback, failCallback, completeCallback);
            RTVibrateLong(callbackId);
        }
